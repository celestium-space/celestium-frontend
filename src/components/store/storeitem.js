...
class StoreItem extends Component {
    ...
    constructor(props) {
        super(props);
        let placeHolder = "https://react.semantic-ui.com/images/avatar/large/matthew.png"
        this.state = {
            url: placeHolder,
    ...
    componentDidMount() {
        ...
        fetch('https://jsonplaceholder.typicode.com/todos/' + this.props.id.toString())
